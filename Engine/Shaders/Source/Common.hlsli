...
float3 CalculatePointLightPBR(PointLight light, float3 worldPos, float3 normal, float3 viewDir,
                             PBRMaterial material)
{
...
float3 CalculateAreaLightPBR(AreaLight light, float3 worldPos, float3 normal, float3 viewDir,
                            PBRMaterial material)
{
